// ignore_for_file: prefer_final_fields, avoid_print, prefer_const_constructors, unnecessary_this, prefer_is_empty, unused_local_variable, depend_on_referenced_packages
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Bluetooth Printer Termal'),
          actions: [
            PopupMenuButton(
              elevation: 3.2,
  ...
  Future<void> printString() async {
    ...
    if (conexionStatus) {
      ...
      // disconnect
      print("disconnect bluetooth $conexionStatus");
    }
  }
  ...
  Future<List<int>> testTicket() async {
    ...
    bytes += generator.text('Special 1: nN ', styles: PosStyles(codeTable: 'CP1252'));
  ...
  Future<void> printWithoutPackage() async {
    // printing without package only from PrintBluetoothTermal
